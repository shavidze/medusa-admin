...
declare type ProductCategoryInput = {
    handle?: string;
    is_internal?: boolean;
    is_active?: boolean;
...
export declare type CreateProductCategoryInput = ProductCategoryInput & {
    name: string;
};
export declare type UpdateProductCategoryInput = ProductCategoryInput & {
    name?: string;
};
...
export declare type ReorderConditions = {
