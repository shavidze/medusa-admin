...
exports.CustomerGroupRepository = database_1.dataSource
    ...
    findWithRelationsAndCount: function (relations, idsOrOptionsWithoutRelations) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var count, entities, customJoinsBuilders, discountConditionId_1, result, entitiesIds, options, toReturn, legacyRelations, groupedRelations, legacySelect, entitiesIdsWithRelations, entitiesAndRelations, entitiesToReturn;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 4:
                        ...
                        delete options.skip;
                        delete options.take;
                        return [4 /*yield*/, this.find(__assign(__assign({}, options), { where: { id: (0, typeorm_1.In)(entitiesIds) } }))];
                    case 5:
                        toReturn = _e.sent();
                        return [2 /*return*/, [toReturn, toReturn.length]];
                    case 6:
                        legacyRelations = (0, utils_1.buildLegacyFieldsListFrom)(relations);
                        groupedRelations = (0, repository_1.getGroupedRelations)(legacyRelations);
                        legacySelect = (0, utils_1.buildLegacyFieldsListFrom)(idsOrOptionsWithoutRelations.select);
                        return [4 /*yield*/, (0, repository_1.queryEntityWithIds)(this, entitiesIds, groupedRelations, idsOrOptionsWithoutRelations.withDeleted, legacySelect)];
                    case 7:
