...
exports.OrderRepository = database_1.dataSource.getRepository(models_1.Order).extend({
    findWithRelations: function (relations, optionsWithoutRelations) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var entities, entitiesIds, groupedRelations, _a, _b, rel, _c, topLevel, entitiesIdsWithRelations, entitiesAndRelations, entitiesAndRelationsById;
            var e_1, _d;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        groupedRelations = {};
                        try {
                            for (_a = __values((0, utils_1.buildLegacyFieldsListFrom)(relations)), _b = _a.next(); !_b.done; _b = _a.next()) {
                                rel = _b.value;
                                _c = __read(rel.split("."), 1), topLevel = _c[0];
