    ...
    findSalesChannels: function (publishableApiKeyId, config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = this.createQueryBuilder("PublishableKeySalesChannel")
                            .select("PublishableKeySalesChannel.sales_channel_id")
                            .innerJoinAndMapOne("PublishableKeySalesChannel.sales_channel_id", models_1.SalesChannel, "SalesChannel", "PublishableKeySalesChannel.sales_channel_id = SalesChannel.id")
                            .where("PublishableKeySalesChannel.publishable_key_id = :publishableApiKeyId", {
                        ...
                        if (config === null || config === void 0 ? void 0 : config.q) {
                            query.andWhere(new typeorm_1.Brackets(function (qb) {
                                qb.where("SalesChannel.description ILIKE :q", {
                                    q: "%".concat(config.q, "%"),
                                }).orWhere("SalesChannel.name ILIKE :q", { q: "%".concat(config.q, "%") });
                            }));
                        }
                        return [4 /*yield*/, query.getMany()];
                    case 1:
                        records = _a.sent();
                        return [2 /*return*/, records.map(function (record) { return record.sales_channel_id; })];
                }
            });
        });
    },
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createQueryBuilder()
                            ...
                            .values(salesChannelIds.map(function (id) { return ({
                            sales_channel_id: id,
