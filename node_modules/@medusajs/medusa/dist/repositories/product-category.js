...
exports.ProductCategoryRepository = database_1.dataSource
    ...
    getFreeTextSearchResultsAndCount: function (options, q, treeScope, includeTree) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var entityName, options_, legacySelect, legacyRelations, selectStatements, queryBuilder, includedTreeRelations, nonTreeRelations, _c, categories, count;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        legacySelect = (0, utils_1.buildLegacyFieldsListFrom)(options_.select);
                        legacyRelations = (0, utils_1.buildLegacyFieldsListFrom)(options_.relations);
                        selectStatements = function (relationName) {
                            ...
                            var selectColumns = legacySelect.length ? legacySelect : modelColumns;
                        ...
                        includedTreeRelations = legacyRelations.filter(function (rel) {
                        ...
                        nonTreeRelations = legacyRelations.filter(function (rel) { return !product_category_1.ProductCategory.treeRelations.includes(rel); });
