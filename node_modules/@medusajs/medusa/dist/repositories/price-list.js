                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (q) {
                            ...
                            query_.where.description = (0, typeorm_1.ILike)("%".concat(q, "%"));
                            query_.where.name = (0, typeorm_1.ILike)("%".concat(q, "%"));
                            query_.where.customer_groups = {
                                name: (0, typeorm_1.ILike)("%".concat(q, "%")),
                            };
                        }
                        return [4 /*yield*/, this.findAndCount(__assign(__assign({}, query_), { relations: {
