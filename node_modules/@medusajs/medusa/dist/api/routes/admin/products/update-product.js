...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, validated, logger, productVariantRepo, productService, pricingService, productVariantService, productVariantInventoryService, inventoryService, manager, rawProduct, _a, product;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        var productServiceTx, variants, product, variantRepo, productVariants, productVariantMap, variantWithIdSet, variantIdsNotBelongingToProduct, variantsToUpdate, variantsToCreate, _a, _b, _c, variantRank, variant, productVariant, allVariantTransactions, transactionDependencies, productVariantServiceTx, variantIdsToDelete;
                        var e_1, _d;
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                ...
                                case 5:
                                    ...
                                    _e.label = 6;
                                case 6:
                                    if (!variantsToCreate.length) return [3 /*break*/, 8];
                                    return [4 /*yield*/, Promise.all(variantsToCreate.map(function (data) { return __awaiter(void 0, void 0, void 0, function () {
                                            var varTransaction, e_2;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        _a.trys.push([0, 2, , 4]);
                                                        return [4 /*yield*/, (0, create_product_variant_1.createVariantTransaction)(transactionDependencies, product.id, data)];
                                                    case 1:
                                                        varTransaction = _a.sent();
