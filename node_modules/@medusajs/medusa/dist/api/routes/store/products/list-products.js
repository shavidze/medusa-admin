...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productService, productVariantInventoryService, pricingService, cartService, validated, _a, cart_id, regionId, currencyCode, filterableFields, listConfig, promises, _b, _c, rawProducts, count, cart, computedProducts;
    var _d, _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 1:
                _b = __read.apply(void 0, [(_f.sent()), 2]), _c = __read(_b[0], 2), rawProducts = _c[0], count = _c[1], cart = _b[1];
                if (validated.cart_id) {
                ...
                return [4 /*yield*/, Promise.all([
                        ...
                        productVariantInventoryService.setProductAvailability(computedProducts, filterableFields.sales_channel_id),
                    ])];
            case 2:
                // We can run them concurrently as the new properties are assigned to the references
                // of the appropriate entity
