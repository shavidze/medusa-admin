...
var ProductVariantInventoryService = /** @class */ (function (_super) {
    ...
    function ProductVariantInventoryService(_a) {
        var stockLocationService = _a.stockLocationService, salesChannelLocationService = _a.salesChannelLocationService, salesChannelInventoryService = _a.salesChannelInventoryService, productVariantService = _a.productVariantService, inventoryService = _a.inventoryService;
        var _this = 
    ...
    ProductVariantInventoryService.prototype.reserveQuantity = function (variantId, quantity, context) {
        if (context === void 0) { context = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var toReserve, variantInventory, locationId, locationIds, _a, locations, count;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 4: return [4 /*yield*/, Promise.all(variantInventory.map(function (inventoryPart) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        itemQuantity = inventoryPart.required_quantity * quantity;
                                        return [4 /*yield*/, this.inventoryService_.createReservationItem(__assign(__assign({}, toReserve), { location_id: locationId, inventory_item_id: inventoryPart.inventory_item_id, quantity: itemQuantity }))];
                                    case 1: return [2 /*return*/, _a.sent()];
                                }
                            });
                        }); }))];
    ...
    ProductVariantInventoryService.prototype.adjustReservationsQuantityByLineItem = function (lineItemId, variantId, locationId, quantity) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, reservations, reservationCount, inventoryItems, productVariantInventory, deltaUpdate_1, exactReservation, remainingQuantity, reservationsToDelete, reservationToUpdate, reservations_1, reservations_1_1, reservation;
            var e_1, _b;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.inventoryService_.deleteReservationItem(exactReservation.id)];
                    case 3:
                        _c.sent();
                        return [2 /*return*/];
                    case 4:
                        ...
                        return [4 /*yield*/, this.inventoryService_.deleteReservationItem(reservationsToDelete.map(function (r) { return r.id; }))];
                    case 5:
                        _c.sent();
                        _c.label = 6;
                    case 6:
    ...
    ProductVariantInventoryService.prototype.validateInventoryAtLocation = function (items, locationId) {
        return __awaiter(this, void 0, void 0, function () {
            var itemsToValidate, itemsToValidate_1, itemsToValidate_1_1, item, pvInventoryItems, _a, inventoryLevels, inventoryLevelCount, pviMap, inventoryLevels_1, inventoryLevels_1_1, inventoryLevel, pvInventoryItem, e_2_1;
            var e_2, _b, e_3, _c;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.inventoryService_.deleteReservationItemsByLineItem(lineItemId)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(variants.map(function (variant) { return __awaiter(_this, void 0, void 0, function () {
                                var variantInventory, locationIds, _a, locations;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            if (!variant.id) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, this.salesChannelLocationService_.listLocationIds(salesChannelId)];
                                        case 2:
                                            locationIds = _b.sent();
                                            return [4 /*yield*/, this.inventoryService_.listInventoryLevels({
                                                    location_id: locationIds,
                                        ...
                                        case 3:
                                            _a = __read.apply(void 0, [_b.sent(), 1]), locations = _a[0];
                                            variant.inventory_quantity = locations.reduce(function (acc, next) { return acc + (next.stocked_quantity || 0); }, 0);
                                            return [2 /*return*/, variant];
                                    }
                                });
                            }); }))];
...
}(utils_1.TransactionBaseService));
