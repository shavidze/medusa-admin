...
var PriceListService = /** @class */ (function (_super) {
    ...
    PriceListService.prototype.list = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var priceListRepo, q, priceListSelector, query, groups, _a, priceLists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, priceListRepo.listAndCount(query)];
                    case 1:
    ...
    PriceListService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var priceListRepo, q, priceListSelector, query, groups, where;
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        if (groups) {
                            ...
                            query.relations.customer_groups = (_b = query.relations.customer_groups) !== null && _b !== void 0 ? _b : true;
                            query.where.customer_groups = __assign(__assign({}, ((_c = query.where.customer_groups) !== null && _c !== void 0 ? _c : {})), { id: (0, typeorm_1.In)(groups.value) });
                        }
                        if (!q) return [3 /*break*/, 2];
                        if (!groups) {
                            query.relations = (_d = query.relations) !== null && _d !== void 0 ? _d : {};
                            query.relations.customer_groups =
                                (_e = query.relations.customer_groups) !== null && _e !== void 0 ? _e : true;
                        }
                        where = [
                            __assign(__assign({}, query.where), { name: (0, typeorm_1.ILike)("%".concat(q, "%")) }),
                            __assign(__assign({}, query.where), { description: (0, typeorm_1.ILike)("%".concat(q, "%")) }),
                            __assign(__assign({}, query.where), { customer_groups: __assign(__assign({}, query.where.customer_groups), { name: (0, typeorm_1.ILike)("%".concat(q, "%")) }) }),
                        ];
                        return [4 /*yield*/, priceListRepo.findAndCount(__assign(__assign({}, query), { where: where }))];
                    case 1: return [2 /*return*/, _f.sent()];
                    case 2: return [4 /*yield*/, priceListRepo.listAndCount(query)];
