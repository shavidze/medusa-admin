            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        query.select = (0, utils_2.buildSelects)(select || []);
                        rels = (0, utils_2.buildRelations)(this.getTotalsRelations({ relations: relations }));
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (relations && relations.length > 0) {
                            query.relations = (0, utils_2.buildRelations)(relations);
                        }
                        query.select = (select === null || select === void 0 ? void 0 : select.length) ? (0, utils_2.buildSelects)(select) : undefined;
