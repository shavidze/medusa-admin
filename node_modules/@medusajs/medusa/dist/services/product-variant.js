            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var productRepo, variantRepo, prices, rest, product, variantExists, toCreate, productVariant, result;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, productRepo.findOne({
                                                ...
                                                relations: (0, utils_1.buildRelations)([
                                                    "variants",
                                                    "variants.options",
                                                    "options",
                                                ]),
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, this.updateVariantPrices([
                                                {
                                                    variantId: result.id,
                                                    prices: prices,
                                                },
    ...
    ProductVariantService.prototype.upsertRegionPrices = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var moneyAmountRepo, where, moneyAmounts, moneyAmountsMapToVariantId, dataToCreate, dataToUpdate, promises;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        moneyAmountRepo = manager.withRepository(this.moneyAmountRepository_);
                                        ...
                                        return [4 /*yield*/, moneyAmountRepo.find({
                                                where: where,
                                            })];
                                    case 1:
                                        ...
                                        data.forEach(function (_a) {
                                            ...
                                            if (moneyAmount) {
                                                ...
                                                dataToCreate.push(moneyAmountRepo.create(__assign(__assign({}, price), { variant_id: variantId })));
                                            }
                                        });
                                        promises = [];
                                    ...
                                    case 1:
                                        ...
                                        data.forEach(function (_a) {
                                            ...
                                            if (moneyAmount) {
                                                ...
                                                dataToCreate.push(moneyAmountRepo.create(__assign(__assign({}, price), { variant_id: variantId, currency_code: price.currency_code.toLowerCase() })));
                                            }
                                        });
                                        promises = [];
                                        if (dataToCreate.length) {
