...
var ProductService = /** @class */ (function (_super) {
    ...
    ProductService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var productRepo, q, productSelector, query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        productRepo = this.activeManager_.withRepository(this.productRepository_);
                        q = selector.q, productSelector = __rest(selector, ["q"]);
                        query = (0, utils_1.buildQuery)(productSelector, config);
                        return [4 /*yield*/, productRepo.findAndCount(query, q)];
    ...
    ProductService.prototype.retrieve_ = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var productRepo, query, product, selectorConstraints;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        productRepo = this.activeManager_.withRepository(this.productRepository_);
                        query = (0, utils_1.buildQuery)(selector, config);
                        return [4 /*yield*/, productRepo.findOne(query)];
                    case 1:
                        product = _a.sent();
                        if (!product) {
