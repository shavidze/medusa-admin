...
import { CreateProductInput, FindProductConfig, ProductOptionInput, ProductSelector, UpdateProductInput } from "../types/product";
...
declare class ProductService extends TransactionBaseService {
    ...
    constructor({ productOptionRepository, productRepository, productVariantRepository, eventBusService, productVariantService, productTypeRepository, productTagRepository, productCategoryRepository, imageRepository, searchService, featureFlagRouter, }: InjectedDependencies);
    /**
