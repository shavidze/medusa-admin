...
import { ICacheService, IInventoryService, IStockLocationService, InventoryItemDTO, ReservationItemDTO, ReserveQuantityContext } from "@medusajs/types";
...
declare class ProductVariantInventoryService extends TransactionBaseService {
    ...
    constructor({ stockLocationService, salesChannelLocationService, salesChannelInventoryService, productVariantService, inventoryService, }: InjectedDependencies);
    /**
    ...
    setVariantAvailability(variants: ProductVariant[] | PricedVariant[], salesChannelId: string | string[] | undefined): Promise<ProductVariant[] | PricedVariant[]>;
