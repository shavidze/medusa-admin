...
var CartCompletionStrategy = /** @class */ (function (_super) {
    ...
    function CartCompletionStrategy(_a) {
        var productVariantInventoryService = _a.productVariantInventoryService, paymentProviderService = _a.paymentProviderService, idempotencyKeyService = _a.idempotencyKeyService, cartService = _a.cartService, orderService = _a.orderService, swapService = _a.swapService, inventoryService = _a.inventoryService;
        var _this = 
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        reservations = [];
                        if (!!allowBackorder) return [3 /*break*/, 11];
                    ...
                    case 10: throw error;
                    case 11:
                        if (!(cart.type === "swap")) return [3 /*break*/, 17];
                        _c.label = 12;
                    case 12:
                        _c.trys.push([12, 15, , 17]);
                    ...
                    case 21:
                        _c.sent();
                        if (!(error_3 && error_3.message === order_1.ORDER_CART_ALREADY_EXISTS_ERROR)) return [3 /*break*/, 23];
