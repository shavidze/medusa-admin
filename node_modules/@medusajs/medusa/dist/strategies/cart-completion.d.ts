...
declare class CartCompletionStrategy extends AbstractCartCompletionStrategy {
    ...
    constructor({ productVariantInventoryService, paymentProviderService, idempotencyKeyService, cartService, orderService, swapService, inventoryService, }: InjectedDependencies);
